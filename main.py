...
# Game Over
game_over_font = pygame.font.SysFont('freesandsbold.tff', 64)
...
def game_over_text():
    game_over_display_text = game_over_font.render("GAME OVER", True, (255, 255, 255))
    screen.blit(game_over_display_text, (250, 250))
